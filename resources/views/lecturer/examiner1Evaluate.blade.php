                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('lecturer.examiner1.index') }}" class="btn btn-sm btn-success">Back to list</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="pl-lg-4">
                            ...
                            <div class="input-group input-group-alternative mb-3">
                                <input class="form-control" id="sectionA" type="number" max="100" placeholder="Lecturer may only key in here" required/>
                            </div>
                            <button type="button" class="btn btn-outline-default" onClick="calculateTotalMarks()">Calculate Total Marks</button>
                    </div>

                    <hr class="my-4"/>
                    <form action="{{ route('lecturer.examiner1.submit' ,$student->id)  }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('examiner1_mark') ? ' has-danger' : '' }}">
                                ...
                                <div class="input-group input-group-alternative mb-3">
                                    <input id="totalExaminer1" class="form-control{{ $errors->has('examiner1_mark') ? ' is-invalid' : '' }}" placeholder="{{ __('Cannot be empty') }}" type="number" min="0" max="60" name="examiner1_mark" value="{{ old('examiner1_mark', $student->examiner1_mark) }}" required autofocus>
                                </div>
                            ...
                            {{-- <div class="text-center">
                                <button type="button" class="btn btn-primary mt-4" onclick="printJS({ printable: 'examiner1', type: 'html', header: 'TDCS 3124' })">
                                    Print PDF
                                </button>
                            </div> --}}
                        </div>
